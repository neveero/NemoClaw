...
Optional env vars:
  TELEGRAM_ANNOUNCE_CHAT_ID      # preferred alias for TELEGRAM_CHAT_ID (cron announcements)
  TELEGRAM_INTERACTIVE_CHAT_ID   # preferred single chat id for bridge interaction allowlist
  ALLOWED_CHAT_IDS
  TELEGRAM_CHAT_ID
...
ANNOUNCE_CHAT_ID="${TELEGRAM_ANNOUNCE_CHAT_ID:-${TELEGRAM_CHAT_ID:-}}"
INTERACTIVE_ALLOWED_CHAT_IDS="${ALLOWED_CHAT_IDS:-}"
if [ -z "$INTERACTIVE_ALLOWED_CHAT_IDS" ] && [ -n "${TELEGRAM_INTERACTIVE_CHAT_ID:-}" ]; then
  INTERACTIVE_ALLOWED_CHAT_IDS="${TELEGRAM_INTERACTIVE_CHAT_ID}"
fi
...
TELEGRAM_CHAT_ID=${ANNOUNCE_CHAT_ID}
ALLOWED_CHAT_IDS=${INTERACTIVE_ALLOWED_CHAT_IDS}
