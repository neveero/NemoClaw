...
usage() {
  ...
  printf "    SHERPA_ONNX_MODEL_DIR         Optional skill integration path\n"
  printf "    TRELLO_API_KEY                Optional skill integration key\n"
  printf "    TRELLO_TOKEN                  Optional skill integration key\n"
