...
config = { \
    ...
    'messages': {'tts': {'auto': 'inbound', 'provider': 'openai', 'modelOverrides': {'enabled': True}, 'openai': {'baseUrl': 'https://api.openai.com/v1', 'model': 'gpt-4o-mini-tts', 'voice': 'ballad', 'speed': 1.5}}}, \
