...
config = { \
    ...
    'messages': {'tts': {'auto': 'inbound', 'provider': 'openai', 'providers': {'openai': {'apiKey': 'openshell:resolve:env:OPENAI_API_KEY', 'baseUrl': 'https://api.openai.com/v1', 'model': 'gpt-4o-mini-tts', 'voice': 'ballad', 'speed': 1.5}}}}, \
